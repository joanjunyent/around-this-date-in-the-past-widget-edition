...
class Around_This_Date_Since_Year_X_Widget extends WP_Widget {
    ...
    public function __construct() {
        ...
        parent::__construct(
            'around-this-date-since-year-x',
            __( '[atd] Around This Date Since Year X', 'around-this-date-widget-edition' ),
            array(
                'classname'     =>  'around_this_date_since_year_x',
                'description'   =>  __( 'Display posts around this date since year X', 'around-this-date-widget-edition' )
            )
        );
    ...
    public function widget( $args, $instance ) {
        ...
        include( plugin_dir_path( __FILE__ ) . '/views/since-widget.php' );
    ...
    public function form( $instance ) {
      ...
      $showexcerpt = strip_tags(stripslashes($new_instance['showexcerpt']));
        ...
        include( plugin_dir_path(__FILE__) . '/views/since-admin.php' );
...
add_action( 'widgets_init', create_function( '', 'register_widget("Around_This_Date_Since_Year_X_Widget");' ) );
