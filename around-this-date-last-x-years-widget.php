...
class Around_This_Date_Last_X_Years_Widget extends WP_Widget {
    ...
    public function __construct() {
        ...
        parent::__construct(
            'around-this-date-last-x-years',
            __( '[atd] Around This Date Last X Years', 'around-this-date-widget-edition' ),
            array(
                'classname'     =>  'around_this_date_last_x_years',
                'description'   =>  __( 'Display posts around this date for the last X years', 'around-this-date-widget-edition' )
            )
        );
    ...
    public function widget( $args, $instance ) {
        ...
        include( plugin_dir_path( __FILE__ ) . '/views/last-widget.php' );
    ...
    public function form( $instance ) {
      ...
      $showexcerpt = strip_tags(stripslashes($new_instance['showexcerpt']));
        ...
        include( plugin_dir_path(__FILE__) . '/views/last-admin.php' );
...
add_action( 'widgets_init', create_function( '', 'register_widget("Around_This_Date_Last_X_Years_Widget");' ) );
