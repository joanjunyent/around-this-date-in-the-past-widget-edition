...
<div class="atd-widget around-this-date-since-year-x-admin">
  ...
  <fieldset>
    ...
    <div class="option">
      <p><label for="sinceyear"><?php _e('Since year X: ', PLUGIN_LOCALE); ?></label>
      <input type="text" id="<?php echo $this->get_field_id('sinceyear'); ?>" name="<?php echo $this->get_field_name('sinceyear'); ?>" value="<?php echo $instance['sinceyear']; ?>" class="" /></p>
    </div>
    <div class="option">
