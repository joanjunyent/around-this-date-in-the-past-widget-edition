...
<div class="atd-widget around-this-date-x-years-ago-admin wrapper">
  ...
  <fieldset>
    ...
    <div class="option">
      <p><label for="yearsago"><?php _e('X years ago: ', PLUGIN_LOCALE); ?></label>
      <input type="text" id="<?php echo $this->get_field_id('yearsago'); ?>" name="<?php echo $this->get_field_name('yearsago'); ?>" value="<?php echo $instance['yearsago']; ?>" class="tiny-text" /></p>
    </div>
    <div class="option">
